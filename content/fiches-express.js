...
(function () {
  ...
  var FICHES = [
    ...
    { part: 'P4', tag: 'RH', q: 'Les 4 groupes de sanctions disciplinaires FPT (rappel)', r: '<strong>G1</strong> : avertissement, blâme (sans conseil de discipline). <strong>G2</strong> : abaissement d\'échelon, exclusion 1-15j. <strong>G3</strong> : rétrogradation, exclusion 16-30j. <strong>G4</strong> : mise à la retraite d\'office, révocation. G2 à G4 : consultation conseil de discipline obligatoire.' },
