...
(function () {
  ...
  var TERMES = [
    ...
    { t: 'DGF', d: 'Dotation Globale de Fonctionnement : principale dotation de l\'État aux collectivités (~27 Mds€/an en 2024). Allouée selon des critères de population, de charges et de ressources.', ref: 'P3·C1' },
    ...
    { t: 'AI Act', d: 'Règlement UE 2024/1689 (en vigueur août 2024) : premier cadre légal mondial sur l\'intelligence artificielle. Classe les IA en 4 niveaux de risque (inacceptable/haut risque/limité/minimal). Les IA « haut risque » utilisées pour des décisions administratives (RSA, emploi) exigent audit, registre de transparence et droit à l\'explication pour le citoyen.', ref: 'P7·C1' },
    { t: 'France Travail', d: 'Nouvel opérateur du service public de l\'emploi depuis le 1er janvier 2024 (ex-Pôle Emploi). Créé par la loi pour le plein emploi du 18 déc. 2023 : regroupe sous coordination commune Pôle Emploi, Missions locales, Cap Emploi et volet emploi des Départements. Les bénéficiaires du RSA sont automatiquement inscrits et doivent signer un Contrat d\'Engagement.', ref: 'P7·C2' },
    { t: 'Contrat d\'Engagement (France Travail)', d: 'Document signé par chaque bénéficiaire du RSA inscrit à France Travail depuis 2024. Prévoit 15 à 20 heures d\'activités hebdomadaires (formation, bénévolat, immersion professionnelle). Son non-respect peut entraîner la suspension du RSA. Enjeu fort pour les CTM/Départements gestionnaires du RSA.', ref: 'P7·C2' },
    { t: 'SIMAR', d: 'Société Immobilière de la Martinique : bailleur social de la CTM. Gère environ 17 000 logements HLM en Martinique. Principal opérateur de la politique du logement social de la CTM, en lien avec l\'ANRU pour les opérations de renouvellement urbain (Trénelle-Citron, Volga-Plage).', ref: 'P7·C2' },
    { t: 'Vie chère (mouvement 2024)', d: 'Mouvement social d\'ampleur ayant touché la Martinique en septembre-octobre 2024 (« Rassemblement pou Pwoteksyon Pep Matinitjé »). Contexte : prix alimentaires 40-49% plus élevés qu\'en métropole. Revendications : baisse des prix sur 54 produits. Accord signé le 16 octobre 2024 encadrant les marges de la grande distribution. La CTM a joué un rôle médiateur et lancé un plan alimentaire local.', ref: 'P7·C3' },
    { t: 'Habilitation normative (art. 73)', d: 'Mécanisme constitutionnel (art. 73 al. 3) permettant aux assemblées des DROM de demander au Parlement l\'autorisation d\'adapter ou de fixer des règles locales dans des matières relevant de la loi. La CTM peut l\'utiliser pour adapter la fiscalité, la politique agricole ou la gestion de l\'eau à la réalité martiniquaise. Enjeu du débat sur l\'Acte IV de la décentralisation (2024).', ref: 'P8·C2' },
    { t: 'Octroi de mer', d: 'Taxe perçue sur toutes les importations et certaines productions locales dans les DROM. Autorisée par dérogation européenne (prolongée jusqu\'en 2027). Représente environ 200 M€/an pour les collectivités de Martinique (communes + CTM). Protège la production locale et finance les services publics locaux. Enjeu : pérennisation de la dérogation post-2027.', ref: 'P8·C2' },
    { t: 'RUP (Région Ultrapériphérique)', d: 'Statut reconnu par l\'article 349 du TFUE à 9 territoires de l\'UE (dont Martinique, Guadeloupe, Guyane, La Réunion, Mayotte). Le droit européen s\'y applique intégralement mais des dérogations sont possibles pour tenir compte des contraintes structurelles (insularité, dépendance économique, risques naturels). Bénéfice : taux de cofinancement européen majoré (FEDER, FSE+, FEADER).', ref: 'P8·C1' },
    { t: 'PADDM', d: 'Plan d\'Aménagement et de Développement Durable de la Martinique : document stratégique de la CTM, équivalent fonctionnel du SRADDET des régions. Opposable aux SCoT et PLU des 34 communes. Intègre les objectifs ZAN, de mobilité, de logement, de transition énergétique et de préservation des ressources naturelles. Révisé tous les 6 ans.', ref: 'P8·C1' }
  ];
